...
async def recibir_ajuste_precio(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("⚠️ Valor inválido. Por favor ingrese un número decimal (ej. 0.35).")
        return
    ...
    if exito:
        ...
        await update.message.reply_text("❌ Error al guardar el ajuste en el sistema.")
